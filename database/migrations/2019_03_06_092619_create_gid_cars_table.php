...
class CreateGidCarsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gid_cars', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('language_gid')->nullable();
